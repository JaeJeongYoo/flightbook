    ...
    private function registerNewUser() {
        ...
        if (empty($_POST['user_name'])) {
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                $this->firstname            = $this->db_connection->real_escape_string($_POST['firstname']);
                $this->middlename           = $this->db_connection->real_escape_string($_POST['middlename']);
                $this->lastname             = $this->db_connection->real_escape_string($_POST['lastname']);
                $this->phone                = $this->db_connection->real_escape_string($_POST['phone']);
                $this->address              = $this->db_connection->real_escape_string($_POST['address']);
                $this->sex                  = $this->db_connection->real_escape_string($_POST['sex']);
                $this->country              = $this->db_connection->real_escape_string($_POST['country']);
                $this->birth                = $this->db_connection->real_escape_string($_POST['birth']);
                ...
                $query_check_user_name = $this->db_connection->query("SELECT * FROM members WHERE user_name = '".$this->user_name."';");
                ...
                if ($query_check_user_name->num_rows == 1) {
                    ...
                    $query_new_user_insert = $this->db_connection->query("INSERT INTO members (user_name, user_password_hash, user_email, firstname, middlename, lastname, phone, address, sex, country, birth) VALUES('".$this->user_name."', '".$this->user_password_hash."', '".$this->user_email."', '".$this->firstname."', '".$this->middlename."', '".$this->lastname."', '".$this->phone."', '".$this->address."', '".$this->sex."', '".$this->country."', '".$this->birth."');");
